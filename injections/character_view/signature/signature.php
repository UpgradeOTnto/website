<?PHP
	...
	// Player Sex
	$MadGD->addText( 'Gênero:', $MadGD->textBold )->setPosition( 10, $row * $height );
	$MadGD->addText( $character->getSex( ) == 1 ? 'Masculino' : 'Feminino' )->setPosition( ); $row++;
	// Player Profession
	$MadGD->addText( 'Profissão:', $MadGD->textBold )->setPosition( 10, $row * $height );
	...
	// Player Residence
	$MadGD->addText( 'Residência:', $MadGD->textBold )->setPosition( 10, $row * $height );
